 ...
 */
UCLASS()
class MOM_REGEN_API ADash : public AMazePiece
{
	GENERATED_BODY()
...
public:
	...
	virtual bool setMesh() override {
		...
		static ConstructorHelpers::FObjectFinder<UStaticMesh> applyMesh(TEXT("StaticMesh'/Game/MazePieceMesh/ClosedCylinderSimple.ClosedCylinderSimple'"));
		if (applyMesh.Object) {
